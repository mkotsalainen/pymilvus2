...
from pymilvus2.client.types import Replica
...
class Partition:
    ...
    def description(self) -> str:
        ...
        Examples:
            >>> from pymilvus2 import connections, Collection, Partition
            >>> connections.connect()
    ...
    def num_entities(self, **kwargs) -> int:
        ...
        Examples:
            >>> from pymilvus2 import connections
            >>> connections.connect()
            >>> from pymilvus2 import Collection, Partition, FieldSchema, CollectionSchema, DataType
    ...
    def search(
        ...
        **kwargs,
        ...
        Examples:
            >>> from pymilvus2 import Collection, FieldSchema, CollectionSchema, DataType
            >>> import random
            >>> schema = CollectionSchema([
            ...     FieldSchema("film_id", DataType.INT64, is_primary=True),
            ...     FieldSchema("films", dtype=DataType.FLOAT_VECTOR, dim=2)
